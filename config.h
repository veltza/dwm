...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_j,      inplacerotate,  {.i = +1} },
	{ MODKEY|ShiftMask|ControlMask, XK_k,      inplacerotate,  {.i = -1} },
	...
	{ MODKEY|ControlMask|ShiftMask, XK_Down,   moveresize,     {.v = "0x 25y 0w 0h" } },
	{ MODKEY|ControlMask|ShiftMask, XK_Up,     moveresize,     {.v = "0x -25y 0w 0h" } },
	{ MODKEY|ControlMask|ShiftMask, XK_Right,  moveresize,     {.v = "25x 0y 0w 0h" } },
	{ MODKEY|ControlMask|ShiftMask, XK_Left,   moveresize,     {.v = "-25x 0y 0w 0h" } },
/*
